...
public class C01 extends TestBase {
    ...
    public void test() throws IOException {
        ...
        WebElement s2 =driver.findElement(By.xpath("//*[@style='background-color: rgb(255, 255, 1);']"));
        FileUtils.copyFile(s2.getScreenshotAs(OutputType.FILE),new File(dosyaYolu));
